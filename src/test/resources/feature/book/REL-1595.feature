@ST_1309 @tagtagtag @this_is_story_tag
...
@SC_1653 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1654 @third_scenario_tag
...
@SC_1655 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1656 @fifth_scenario_tag
