@ST_1293 @tagtagtag @this_is_story_tag
...
@SC_1601 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1602 @third_scenario_tag
...
@SC_1603 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1604 @fifth_scenario_tag
