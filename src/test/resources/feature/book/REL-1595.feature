@ST_1350 @tagtagtag @this_is_story_tag
...
@SC_1859 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1860 @third_scenario_tag
...
@SC_1861 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1862 @fifth_scenario_tag
