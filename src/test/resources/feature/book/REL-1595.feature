@ST_25 @tagtagtag @this_is_story_tag
...
@SC_139 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_140 @third_scenario_tag
...
@SC_141 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_142 @fifth_scenario_tag
