@ST_59 @tagtagtag @this_is_story_tag
...
@SC_263 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264 @third_scenario_tag
...
@SC_265 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_266 @fifth_scenario_tag
