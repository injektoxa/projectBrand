@ST_106 @tagtagtag @this_is_story_tag
...
@SC_391 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_392 @third_scenario_tag
...
@SC_393 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_394 @fifth_scenario_tag
