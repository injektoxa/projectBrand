@ST_17 @tagtagtag @this_is_story_tag
...
@SC_91 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_92 @third_scenario_tag
...
@SC_93 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_94 @fifth_scenario_tag
