@ST_1178 @tagtagtag @this_is_story_tag
...
@SC_1200 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1201 @third_scenario_tag
...
@SC_1202 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_1203 @fifth_scenario_tag
