...
When in thывввввывis sssdddtorddy background hasn't givааввыыen keвввywвввorddrrвhddttp://dfirst.localhost/аа

@SC_26 @Critical @Test_1
Scenario: Check scenario
Given thisыы scппenario must started from given ввkeаyввwdddddordddd
Then gherkin ввpaыыыrsdыыafsввer must be ok with parsingdd

@SC_27
Scenario: 
Given stsыыsddddssdorввy
When in ыыыddthiввsddвd story background hasn't given keyword
