...
When in fffthывdвaddsdfddвввывis sssdddtorddy backgrouggnd dhddasnddd't givааввыыen keвввywвввordgghdrrвhddttp://dfirst.localhost/аа

@SC_26 @Critical @Test_1
Scenario: Check scenario
Given thisыdddhdы scdddппвввenario must started fromff ssgidven вквkeаyввwdddgggddordddd
